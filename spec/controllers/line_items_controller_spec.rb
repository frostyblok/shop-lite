...
RSpec.describe LineItemsController, type: :controller do
  ...
  # This should return the minimal set of attributes required to index a valid
  ...
  describe "POST #index" do
    context "with valid params" do
      it "creates a new LineItem" do
        expect {
          post :index, params: { line_item: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :index, params: { line_item: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
